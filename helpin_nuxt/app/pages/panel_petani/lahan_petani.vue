      ...
      <div class="overflow-y-auto overflow-x-hidden h-full no-scrollbar flex flex-col justify-between">
        <div>
          ...
          <nav class="flex flex-col gap-2 pl-4">
            ...
            <a href="inventori_petani" class="flex items-center gap-4 px-4 py-4 text-gray-200 hover:bg-[#23533b] rounded-l-full transition-colors font-medium">
              <ArchiveIcon class="w-5 h-5" />
              Inventori
            </a>
            <a href="lahan_petani" class="active-menu relative flex items-center gap-4 px-4 py-4 bg-[#f4f7f5] text-[#1a402d] rounded-l-full font-bold shadow-[-5px_0_10px_rgba(0,0,0,0.05)]">
        ...
        <section class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-6 w-full flex flex-col flex-1">
          <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            ...
            <button @click="openModal('create')" class="w-full sm:w-auto px-4 py-2.5 font-bold text-white bg-[#1a402d] hover:bg-[#143222] rounded-lg transition shadow-md flex items-center justify-center gap-2">
              <PlusIcon class="w-5 h-5" /> Tambah Lahan
            </button>
          </div>
