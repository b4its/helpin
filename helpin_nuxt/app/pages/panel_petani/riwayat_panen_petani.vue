      ...
      <div class="overflow-y-auto overflow-x-hidden h-full no-scrollbar flex flex-col justify-between">
        <div>
          ...
          <nav class="flex flex-col gap-2 pl-4">
            <NuxtLink to="/panel_petani/dashboard_petani" class="flex items-center gap-4 px-4 py-4 text-gray-200 hover:bg-[#23533b] rounded-l-full transition-colors font-medium">
              <LayoutDashboardIcon class="w-5 h-5" />
              Dashboard
            </NuxtLink>
            <NuxtLink to="/panel_petani/inventori_petani" class="flex items-center gap-4 px-4 py-4 text-gray-200 hover:bg-[#23533b] rounded-l-full transition-colors font-medium">
              <ArchiveIcon class="w-5 h-5" />
              Inventori
            </NuxtLink>
            <NuxtLink to="/panel_petani/lahan_petani" class="flex items-center gap-4 px-4 py-4 text-gray-200 hover:bg-[#23533b] rounded-l-full transition-colors font-medium">
              <MapIcon class="w-5 h-5" />
              Lahan
            </NuxtLink>
            <NuxtLink to="/panel_petani/hasil_panen_petani" class="flex items-center gap-4 px-4 py-4 text-gray-200 hover:bg-[#23533b] rounded-l-full transition-colors font-medium">
              <WheatIcon class="w-5 h-5" />
              Hasil Panen
            </NuxtLink>
            <NuxtLink to="/panel_petani/riwayat_panen_petani" class="active-menu relative flex items-center gap-4 px-4 py-4 bg-[#f4f7f5] text-[#1a402d] rounded-l-full font-bold shadow-[-5px_0_10px_rgba(0,0,0,0.05)]">
