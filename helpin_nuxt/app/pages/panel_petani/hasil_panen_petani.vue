      ...
      <div class="overflow-y-auto overflow-x-hidden h-full no-scrollbar flex flex-col justify-between">
        <div>
          ...
          <nav class="flex flex-col gap-2 pl-4">
            ...
            <NuxtLink to="/panel_petani/hasil_panen_petani" class="active-menu relative flex items-center gap-4 px-4 py-4 bg-[#f4f7f5] text-[#1a402d] rounded-l-full font-bold shadow-[-5px_0_10px_rgba(0,0,0,0.05)]">
