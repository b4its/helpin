        ...
        <div>
          <div class="px-6 md:px-8 py-8 flex justify-between items-center">
            <div class="flex items-baseline gap-1">
              <h1 class="text-3xl font-extrabold tracking-wider italic">HELPIN</h1>
              <span class="text-[10px] uppercase font-bold text-green-400">Quality</span>
            </div>
          ...
          <div class="px-6 md:px-8 mb-8 border-b border-[#23533b] pb-6 bg-[#173a28]">
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-xs font-semibold text-green-400 uppercase tracking-widest">Analytics Active</span>
            </div>
            <h2 class="text-xl font-bold mb-2">Petani Suki</h2>
            <span class="inline-block px-3 py-1 text-[10px] font-bold border border-green-600 text-green-400 rounded uppercase">Verified Breeder</span>
          </div>
