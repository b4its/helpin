        ...
        <div>
          ...
          <div class="px-6 md:px-8 mb-8 border-b border-[#23533b] pb-6 bg-[#173a28]">
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-xs font-semibold text-green-400 uppercase tracking-widest">Breeder Pro</span>
            </div>
            <h2 class="text-xl font-bold mb-2">Petani Suki</h2>
            <span class="inline-block px-3 py-1 text-[10px] font-bold border border-green-600 text-green-400 rounded uppercase tracking-widest">Verified Admin</span>
          </div>
        ...
        <div class="p-6">
          <div class="bg-[#143222] rounded-xl p-4 flex items-center justify-between border border-[#1d462f]">
            <div class="min-w-0 text-white">
              <span class="text-[10px] text-gray-400 font-semibold uppercase block">Breeding Control</span>
...
const menus = [
  ...
  { name: 'Ternak', icon: DogIcon, path: '/panel_peternak/ternak_peternak' },
